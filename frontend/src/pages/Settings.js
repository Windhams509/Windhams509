...
const Settings = () => {
  ...
  return (
    <div className="min-h-screen bg-black">
                      ...
                      <div className="flex items-center justify-between mb-2">
                        ...
                        {connectedServices[service.name] ? (
                          ...
                          <div className="flex flex-col space-y-2">
                            {service.supportsDeviceCode && (
                              <button
                                onClick={() => handleDeviceCodeAuth(service.name)}
                                disabled={loading}
                                className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded text-sm disabled:opacity-50 flex items-center justify-center space-x-2"
                              >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 18h.01M8 21h8a2 2 0 002-2V5a2 2 0 00-2-2H8a2 2 0 00-2 2v14a2 2 0 002 2z" />
                                </svg>
                                <span>Quick Connect (Device Code)</span>
                              </button>
                            )}
      ...
      {/* Device Code Modal */}
      {deviceCodeModal.show && (
        <div className="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50">
          <div className="bg-gray-900 rounded-lg p-8 max-w-md w-full mx-4 border border-gray-700">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-2xl font-bold text-white">Connect {deviceCodeModal.service}</h2>
              <button
                onClick={closeDeviceCodeModal}
            ...
            <div className="text-center space-y-6">
              <div className="bg-gray-800 rounded-lg p-6">
                <p className="text-gray-300 mb-4">Enter this code on your device:</p>
              ...
              <div className="space-y-2">
                ...
                <p className="text-blue-400 text-sm font-mono break-all">
                  {deviceCodeModal.verificationUrl}
                </p>
                <p className="text-gray-400 text-sm">
