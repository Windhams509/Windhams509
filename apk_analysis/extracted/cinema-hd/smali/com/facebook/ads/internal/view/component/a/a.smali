...
.method public constructor <init>(Lcom/facebook/ads/internal/view/component/a/d;Lcom/facebook/ads/internal/adapters/a/d;Z)V
    ...
    invoke-static {p2, v3}, Lcom/facebook/ads/internal/q/a/x;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
    ...
    :goto_3
    invoke-virtual {v5, v8, v9, v4, v4}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V
    ...
    :goto_4
    invoke-direct {v8, p3, v2}, Landroid/widget/LinearLayout$LayoutParams;-><init>(II)V

    invoke-virtual {v8, v4, v4, v4, v4}, Landroid/widget/LinearLayout$LayoutParams;->setMargins(IIII)V

    const/high16 p3, 0x3f800000    # 1.0f

    iput p3, v8, Landroid/widget/LinearLayout$LayoutParams;->weight:F
    ...
    invoke-virtual {v3, p3, v8}, Landroid/widget/LinearLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p0, p3, v2}, Landroid/widget/RelativeLayout;->addView(Landroid/view/View;Landroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-virtual {p2, v7, p3, v7, v7}, Landroid/widget/RelativeLayout$LayoutParams;->setMargins(IIII)V
