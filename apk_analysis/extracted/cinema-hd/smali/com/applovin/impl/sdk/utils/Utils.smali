...
.method public static checkCachedResourcesExist(ZLcom/applovin/impl/sdk/ad/e;Lcom/applovin/impl/sdk/m;Landroid/content/Context;)Ljava/util/List;
    .locals 7
    ...
    invoke-virtual {p2}, Lcom/applovin/impl/sdk/m;->aa()Lcom/applovin/impl/sdk/r;
    ...
    :cond_2
    invoke-virtual {p2}, Lcom/applovin/impl/sdk/m;->ab()Lcom/applovin/impl/sdk/q;
    ...
    invoke-virtual {v4, v5, p3}, Lcom/applovin/impl/sdk/q;->b(Ljava/lang/String;Landroid/content/Context;)Z
    ...
    invoke-virtual {p1, v1, p3}, Lcom/applovin/impl/sdk/q;->b(Ljava/lang/String;Landroid/content/Context;)Z
...
.method public static checkExoPlayerEligibility(Lcom/applovin/impl/sdk/m;)Z
    .locals 3
...
.method public static close(Ljava/io/Closeable;Lcom/applovin/impl/sdk/m;)V
    .locals 3
...
.method public static disconnect(Ljava/net/HttpURLConnection;Lcom/applovin/impl/sdk/m;)V
    .locals 3
...
.method private static generateClassesList(Ljava/util/List;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v5}, Lcom/applovin/impl/sdk/utils/Utils;->getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/lang/String;Ljava/util/Map;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v7}, Lcom/applovin/impl/sdk/utils/Utils;->getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;ZLcom/applovin/impl/sdk/m;)Ljava/util/List;
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/lang/String;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;ZLcom/applovin/impl/sdk/m;)Ljava/util/List;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
    .locals 6
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v5}, Lcom/applovin/impl/sdk/utils/Utils;->getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static/range {v0 .. v6}, Lcom/applovin/impl/sdk/utils/Utils;->getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;ZLcom/applovin/impl/sdk/m;)Ljava/util/List;
...
.method public static getPostbacks(Ljava/lang/String;Lorg/json/JSONObject;Ljava/util/Map;Ljava/lang/String;Ljava/util/Map;ZLcom/applovin/impl/sdk/m;)Ljava/util/List;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {p6}, Lcom/applovin/impl/sdk/m;->A()Lcom/applovin/impl/sdk/v;
...
.method public static getServerAdjustedUnixTimestampMillis(Lcom/applovin/impl/sdk/m;)J
    .locals 8
...
.method public static getZone(Lorg/json/JSONObject;Lcom/applovin/impl/sdk/m;)Lcom/applovin/impl/sdk/ad/d;
    .locals 3
...
.method public static hasAndroidCoreJsonLibrary(Lcom/applovin/impl/sdk/m;)Z
    .locals 3
    ...
    invoke-virtual {p0}, Lcom/applovin/impl/sdk/m;->A()Lcom/applovin/impl/sdk/v;
...
.method public static isPubInDebugMode(Landroid/content/Context;Lcom/applovin/impl/sdk/m;)Z
    .locals 2
...
.method public static isUserAgentCollectionEnabled(Lcom/applovin/impl/sdk/m;)Z
    .locals 1

    invoke-virtual {p0}, Lcom/applovin/impl/sdk/m;->p()Lcom/applovin/sdk/AppLovinSdkSettings;
...
.method public static isVideoMutedInitially(Lcom/applovin/impl/sdk/m;)Z
    .locals 1
...
.method public static maybeHandleNoFillResponseForPublisher(Ljava/lang/String;Lcom/applovin/mediation/MaxAdFormat;Lorg/json/JSONObject;Lcom/applovin/impl/sdk/m;)V
    .locals 2
    ...
    invoke-virtual {p3}, Lcom/applovin/impl/sdk/m;->z()Ljava/lang/String;
    ...
    invoke-virtual {p3}, Lcom/applovin/impl/sdk/m;->L()Landroid/content/Context;
...
.method public static maybeRetrieveNonDummyAd(Lcom/applovin/sdk/AppLovinAd;Lcom/applovin/impl/sdk/m;)Lcom/applovin/sdk/AppLovinAd;
    .locals 3
...
.method public static objectIsOfType(Ljava/lang/Object;Ljava/util/List;Lcom/applovin/impl/sdk/m;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    :cond_0
    invoke-static {p1, p2}, Lcom/applovin/impl/sdk/utils/Utils;->generateClassesList(Ljava/util/List;Lcom/applovin/impl/sdk/m;)Ljava/util/List;
    ...
    invoke-static {v1, p1, p2}, Lcom/applovin/impl/sdk/utils/Utils;->objectIsOfType(Ljava/lang/Object;Ljava/util/List;Lcom/applovin/impl/sdk/m;)Z
...
.method public static openUri(Landroid/content/Context;Landroid/net/Uri;Lcom/applovin/impl/sdk/m;)Z
    .locals 4
    ...
    :cond_2
    invoke-virtual {p2}, Lcom/applovin/impl/sdk/m;->ad()Lcom/applovin/impl/sdk/y;

    move-result-object v2

    invoke-virtual {v2}, Lcom/applovin/impl/sdk/y;->c()V
    ...
    invoke-virtual {p0}, Lcom/applovin/impl/sdk/y;->d()V
...
.method public static retrieveParentActivity(Landroid/view/View;Lcom/applovin/impl/sdk/m;)Landroid/app/Activity;
    .locals 4
...
.method public static sanitizeSuperProperty(Ljava/lang/Object;Lcom/applovin/impl/sdk/m;)Ljava/lang/Object;
    .locals 4
    ...
    invoke-static {v1, p1}, Lcom/applovin/impl/sdk/utils/Utils;->sanitizeSuperProperty(Ljava/lang/Object;Lcom/applovin/impl/sdk/m;)Ljava/lang/Object;
...
.method public static toUrlSafeMap(Ljava/util/Map;Lcom/applovin/impl/sdk/m;)Ljava/util/Map;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-static {v2, p1}, Lcom/applovin/impl/sdk/utils/StringUtils;->encodeUriString(Ljava/lang/String;Lcom/applovin/impl/sdk/m;)Ljava/lang/String;
...
.method public static tryToGetExoPlayerVersionCode()I
    ...
    sget-object v1, Lcom/google/android/exoplayer2/ExoPlayerLibraryInfo;->a:Ljava/lang/String;
...
.method public static validateAdSdkKey(Lcom/applovin/sdk/AppLovinAd;Lcom/applovin/impl/sdk/m;)V
    .locals 3
