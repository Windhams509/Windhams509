.class Lcom/database/daos/CrawlCountDAO_Impl$2;
...
.method constructor <init>(Lcom/database/daos/CrawlCountDAO_Impl;Landroidx/room/RoomDatabase;)V
    ...
    iput-object p1, p0, Lcom/database/daos/CrawlCountDAO_Impl$2;->d:Lcom/database/daos/CrawlCountDAO_Impl;
...
.method public d()Ljava/lang/String;
    ...
    const-string v0, "UPDATE OR IGNORE `CrawlCount` SET `id` = ?,`provider` = ?,`host` = ?,`count` = ? WHERE `id` = ?"
...
.method public bridge synthetic g(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Lcom/database/daos/CrawlCountDAO_Impl$2;->i(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/database/entitys/CrawlCount;)V

    return-void
.end method

.method public i(Landroidx/sqlite/db/SupportSQLiteStatement;Lcom/database/entitys/CrawlCount;)V
    .locals 3
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
