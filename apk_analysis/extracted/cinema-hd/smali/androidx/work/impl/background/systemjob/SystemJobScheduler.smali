...
.method public static b(Landroid/content/Context;)V
    ...
    .line 2
    invoke-static {p0, v0}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->f(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
...
.method private static e(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 1
    invoke-static {p0, p1}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->f(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    .line 4
    invoke-static {v0}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->g(Landroid/app/job/JobInfo;)Ljava/lang/String;
...
.method public static h(Landroid/content/Context;Landroidx/work/impl/WorkManagerImpl;)Z
    .locals 7
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-virtual {v1}, Landroidx/work/impl/WorkDatabase;->y()Landroidx/work/impl/model/SystemIdInfoDao;

    move-result-object v1

    invoke-interface {v1}, Landroidx/work/impl/model/SystemIdInfoDao;->b()Ljava/util/List;
    ...
    .line 8
    invoke-static {v3}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->g(Landroid/app/job/JobInfo;)Ljava/lang/String;
    ...
    .line 17
    :try_start_0
    invoke-virtual {p0}, Landroidx/work/impl/WorkDatabase;->B()Landroidx/work/impl/model/WorkSpecDao;
    ...
    .line 19
    invoke-interface {p1, v1, v3, v4}, Landroidx/work/impl/model/WorkSpecDao;->l(Ljava/lang/String;J)I
...
.method public varargs a([Landroidx/work/impl/model/WorkSpec;)V
    ...
    invoke-interface {v6, v7}, Landroidx/work/impl/model/WorkSpecDao;->g(Ljava/lang/String;)Landroidx/work/impl/model/WorkSpec;
    ...
    .line 11
    :cond_1
    invoke-virtual {v0}, Landroidx/work/impl/WorkDatabase;->y()Landroidx/work/impl/model/SystemIdInfoDao;
    ...
    .line 14
    invoke-virtual {v7}, Landroidx/work/impl/WorkManagerImpl;->i()Landroidx/work/Configuration;
    ...
    .line 15
    invoke-virtual {v8}, Landroidx/work/impl/WorkManagerImpl;->i()Landroidx/work/Configuration;
    ...
    invoke-virtual {v8}, Landroidx/work/impl/WorkManagerImpl;->o()Landroidx/work/impl/WorkDatabase;

    move-result-object v8

    .line 19
    invoke-virtual {v8}, Landroidx/work/impl/WorkDatabase;->y()Landroidx/work/impl/model/SystemIdInfoDao;

    move-result-object v8

    .line 20
    invoke-interface {v8, v6}, Landroidx/work/impl/model/SystemIdInfoDao;->c(Landroidx/work/impl/model/SystemIdInfo;)V

    .line 21
    :cond_3
    invoke-virtual {p0, v5, v7}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->i(Landroidx/work/impl/model/WorkSpec;I)V
    ...
    invoke-static {v6, v8, v9}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->e(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
    ...
    .line 29
    invoke-virtual {v6}, Landroidx/work/impl/WorkManagerImpl;->i()Landroidx/work/Configuration;
    ...
    .line 32
    :goto_2
    invoke-virtual {p0, v5, v6}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->i(Landroidx/work/impl/model/WorkSpec;I)V
...
.method public cancel(Ljava/lang/String;)V
    ...
    invoke-static {v0, v1, p1}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->e(Landroid/content/Context;Landroid/app/job/JobScheduler;Ljava/lang/String;)Ljava/util/List;
...
.method public i(Landroidx/work/impl/model/WorkSpec;I)V
    .locals 8
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 12
    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->i(Landroidx/work/impl/model/WorkSpec;I)V
    :try_end_0
    ...
    invoke-static {p2, v0}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->f(Landroid/content/Context;Landroid/app/job/JobScheduler;)Ljava/util/List;
    ...
    .line 18
    invoke-virtual {p2}, Landroidx/work/impl/WorkManagerImpl;->o()Landroidx/work/impl/WorkDatabase;

    move-result-object p2

    invoke-virtual {p2}, Landroidx/work/impl/WorkDatabase;->B()Landroidx/work/impl/model/WorkSpecDao;

    move-result-object p2

    invoke-interface {p2}, Landroidx/work/impl/model/WorkSpecDao;->d()Ljava/util/List;
    ...
    .line 19
    invoke-virtual {p2}, Landroidx/work/impl/WorkManagerImpl;->i()Landroidx/work/Configuration;
