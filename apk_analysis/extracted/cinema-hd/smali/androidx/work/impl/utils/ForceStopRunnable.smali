...
.method private static e(Landroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    .line 1
    invoke-static {p0}, Landroidx/work/impl/utils/ForceStopRunnable;->d(Landroid/content/Context;)Landroid/content/Intent;
...
.method public b()Z
    ...
    invoke-static {v0, v2}, Landroidx/work/impl/background/systemjob/SystemJobScheduler;->h(Landroid/content/Context;Landroidx/work/impl/WorkManagerImpl;)Z
    ...
    .line 4
    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->B()Landroidx/work/impl/model/WorkSpecDao;

    move-result-object v3

    .line 5
    invoke-virtual {v2}, Landroidx/work/impl/WorkDatabase;->A()Landroidx/work/impl/model/WorkProgressDao;
    ...
    .line 7
    :try_start_0
    invoke-interface {v3}, Landroidx/work/impl/model/WorkSpecDao;->p()Ljava/util/List;
    ...
    invoke-interface {v3, v9, v10}, Landroidx/work/impl/model/WorkSpecDao;->a(Landroidx/work/WorkInfo$State;[Ljava/lang/String;)I
    ...
    invoke-interface {v3, v8, v9, v10}, Landroidx/work/impl/model/WorkSpecDao;->l(Ljava/lang/String;J)I

    goto :goto_2

    .line 12
    :cond_2
    invoke-interface {v4}, Landroidx/work/impl/model/WorkProgressDao;->a()V
...
.method public c()V
    ...
    invoke-virtual {v0, v2}, Landroidx/work/impl/utils/PreferenceUtils;->c(Z)V
...
.method public f()Z
    ...
    invoke-static {v3, v0}, Landroidx/work/impl/utils/ForceStopRunnable;->e(Landroid/content/Context;I)Landroid/app/PendingIntent;
    ...
    invoke-static {v0}, Landroidx/work/impl/utils/ForceStopRunnable;->h(Landroid/content/Context;)V
    :try_end_0
    ...
    invoke-virtual {v3, v4, v0, v5}, Landroidx/work/Logger;->h(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Throwable;)V
...
.method public run()V
    ...
    .line 5
    :try_start_2
    invoke-virtual {p0}, Landroidx/work/impl/utils/ForceStopRunnable;->c()V
    :try_end_2
