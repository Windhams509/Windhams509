...
.method public bridge synthetic g(Landroidx/sqlite/db/SupportSQLiteStatement;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1, p2}, Landroidx/work/impl/model/WorkSpecDao_Impl$1;->j(Landroidx/sqlite/db/SupportSQLiteStatement;Landroidx/work/impl/model/WorkSpec;)V

    return-void
.end method

.method public j(Landroidx/sqlite/db/SupportSQLiteStatement;Landroidx/work/impl/model/WorkSpec;)V
    .locals 10
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 14
    :cond_3
    invoke-interface {p1, v1, v0}, Landroidx/sqlite/db/SupportSQLiteProgram;->t(I[B)V
    ...
    .line 34
    invoke-interface {p1, v6, v8, v9}, Landroidx/sqlite/db/SupportSQLiteProgram;->s(IJ)V
    ...
    .line 36
    invoke-interface {p1, v5, v8, v9}, Landroidx/sqlite/db/SupportSQLiteProgram;->s(IJ)V
    ...
    .line 38
    invoke-interface {p1, v4, v5, v6}, Landroidx/sqlite/db/SupportSQLiteProgram;->s(IJ)V
    ...
    .line 40
    invoke-interface {p1, v3, v4, v5}, Landroidx/sqlite/db/SupportSQLiteProgram;->s(IJ)V
    ...
    .line 42
    invoke-interface {p1, v2, v3, v4}, Landroidx/sqlite/db/SupportSQLiteProgram;->s(IJ)V
    ...
    .line 46
    invoke-interface {p1, v7}, Landroidx/sqlite/db/SupportSQLiteProgram;->v(I)V

    goto :goto_5

    .line 47
    :cond_5
    invoke-interface {p1, v7, p2}, Landroidx/sqlite/db/SupportSQLiteProgram;->t(I[B)V

    goto :goto_5

    .line 48
    :cond_6
    invoke-interface {p1, v6}, Landroidx/sqlite/db/SupportSQLiteProgram;->v(I)V

    .line 49
    invoke-interface {p1, v5}, Landroidx/sqlite/db/SupportSQLiteProgram;->v(I)V

    .line 50
    invoke-interface {p1, v4}, Landroidx/sqlite/db/SupportSQLiteProgram;->v(I)V

    .line 51
    invoke-interface {p1, v3}, Landroidx/sqlite/db/SupportSQLiteProgram;->v(I)V

    .line 52
    invoke-interface {p1, v2}, Landroidx/sqlite/db/SupportSQLiteProgram;->v(I)V
