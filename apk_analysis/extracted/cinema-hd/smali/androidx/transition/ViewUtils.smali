...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/transition/ViewUtils;->e:Landroid/util/Property;
...
.method private static b()V
    ...
    .line 1
    sget-boolean v0, Landroidx/transition/ViewUtils;->c:Z
    ...
    sput-object v1, Landroidx/transition/ViewUtils;->b:Ljava/lang/reflect/Field;
    ...
    .line 5
    :goto_0
    sput-boolean v0, Landroidx/transition/ViewUtils;->c:Z

    :cond_0
    return-void
.end method

.method static c(Landroid/view/View;)Landroidx/transition/ViewOverlayImpl;
    .locals 1
...
.method static d(Landroid/view/View;)F
    ...
    invoke-virtual {v0, p0}, Landroidx/transition/ViewUtilsBase;->b(Landroid/view/View;)F
...
.method static e(Landroid/view/View;)Landroidx/transition/WindowIdImpl;
    .locals 1
...
.method static f(Landroid/view/View;)V
    ...
    invoke-virtual {v0, p0}, Landroidx/transition/ViewUtilsBase;->c(Landroid/view/View;)V
...
.method static g(Landroid/view/View;IIII)V
    ...
    invoke-virtual/range {v0 .. v5}, Landroidx/transition/ViewUtilsBase;->d(Landroid/view/View;IIII)V
...
.method static h(Landroid/view/View;F)V
    ...
    invoke-virtual {v0, p0, p1}, Landroidx/transition/ViewUtilsBase;->e(Landroid/view/View;F)V
...
.method static i(Landroid/view/View;I)V
    ...
    .line 1
    invoke-static {}, Landroidx/transition/ViewUtils;->b()V

    .line 2
    sget-object v0, Landroidx/transition/ViewUtils;->b:Ljava/lang/reflect/Field;
    ...
    .line 4
    sget-object v1, Landroidx/transition/ViewUtils;->b:Ljava/lang/reflect/Field;
...
.method static j(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {v0, p0, p1}, Landroidx/transition/ViewUtilsBase;->f(Landroid/view/View;Landroid/graphics/Matrix;)V
...
.method static k(Landroid/view/View;Landroid/graphics/Matrix;)V
    ...
    invoke-virtual {v0, p0, p1}, Landroidx/transition/ViewUtilsBase;->g(Landroid/view/View;Landroid/graphics/Matrix;)V
