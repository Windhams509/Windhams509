...
# static fields
.field public static final i:Lkotlinx/coroutines/scheduling/CoroutineScheduler$Companion;
...
.field public final g:Lkotlinx/coroutines/scheduling/GlobalQueue;

.field public final h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->i:Lkotlinx/coroutines/scheduling/CoroutineScheduler$Companion;
    ...
    sput-object v0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->m:Lkotlinx/coroutines/internal/Symbol;
...
.method public constructor <init>(IIJLjava/lang/String;)V
    ...
    iput-object p2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lkotlinx/coroutines/scheduling/GlobalQueue;
    ...
    iput-object p2, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
...
.method private final I()Z
    ...
    .line 1
    :cond_0
    invoke-direct {p0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->l()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
...
.method private final b(Lkotlinx/coroutines/scheduling/Task;)Z
    ...
    .line 2
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lkotlinx/coroutines/scheduling/GlobalQueue;
...
.method private final d()I
    ...
    .line 1
    iget-object v0, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
    ...
    .line 9
    iget-object v7, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
    ...
    .line 11
    iget-object v8, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
...
.method public static synthetic j(Lkotlinx/coroutines/scheduling/CoroutineScheduler;Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/TaskContext;ZILjava/lang/Object;)V
    .locals 0
    ...
    sget-object p2, Lkotlinx/coroutines/scheduling/TasksKt;->f:Lkotlinx/coroutines/scheduling/TaskContext;
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->i(Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/TaskContext;Z)V

    return-void
.end method

.method private final k(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
    .locals 1

    .line 1
    invoke-virtual {p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->h()Ljava/lang/Object;

    move-result-object p1

    .line 2
    :goto_0
    sget-object v0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->m:Lkotlinx/coroutines/internal/Symbol;
    ...
    .line 4
    invoke-virtual {p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->g()I
...
.method private final l()Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;
    .locals 9
    ...
    .line 3
    invoke-direct {p0, v6}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->k(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
...
.method private final q(Z)V
    ...
    .line 3
    :cond_1
    invoke-direct {p0, v0, v1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->x(J)Z
...
.method private final w(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;Lkotlinx/coroutines/scheduling/Task;Z)Lkotlinx/coroutines/scheduling/Task;
    ...
    .line 2
    :cond_1
    iget-object v0, p2, Lkotlinx/coroutines/scheduling/Task;->c:Lkotlinx/coroutines/scheduling/TaskContext;
    ...
    .line 5
    iget-object p1, p1, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->b:Lkotlinx/coroutines/scheduling/WorkQueue;
...
.method private final x(J)Z
    ...
    .line 1
    invoke-static {v1, p1}, Lkotlin/ranges/RangesKt;->b(II)I
...
.method static synthetic y(Lkotlinx/coroutines/scheduling/CoroutineScheduler;JILjava/lang/Object;)Z
    .locals 0
...
.method public final e(Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/TaskContext;)Lkotlinx/coroutines/scheduling/Task;
    .locals 3

    .line 1
    sget-object v0, Lkotlinx/coroutines/scheduling/TasksKt;->e:Lkotlinx/coroutines/scheduling/SchedulerTimeSource;
    ...
    iput-wide v0, p1, Lkotlinx/coroutines/scheduling/Task;->b:J

    .line 4
    iput-object p2, p1, Lkotlinx/coroutines/scheduling/Task;->c:Lkotlinx/coroutines/scheduling/TaskContext;
...
.method public final i(Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/TaskContext;Z)V
    .locals 1
    ...
    .line 2
    :cond_0
    invoke-virtual {p0, p1, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->e(Ljava/lang/Runnable;Lkotlinx/coroutines/scheduling/TaskContext;)Lkotlinx/coroutines/scheduling/Task;
    ...
    .line 5
    invoke-direct {p0, v0}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->b(Lkotlinx/coroutines/scheduling/Task;)Z
    ...
    .line 7
    :goto_1
    iget-object p1, p1, Lkotlinx/coroutines/scheduling/Task;->c:Lkotlinx/coroutines/scheduling/TaskContext;

    invoke-interface {p1}, Lkotlinx/coroutines/scheduling/TaskContext;->b()I
    ...
    .line 9
    :cond_5
    invoke-direct {p0, p2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->q(Z)V
...
.method public final m(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)Z
    .locals 8
    ...
    .line 4
    iget-object v6, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
...
.method public final n(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;II)V
    .locals 8
    ...
    .line 2
    invoke-direct {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->k(Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;)I
...
.method public final o(Lkotlinx/coroutines/scheduling/Task;)V
    .locals 2
...
.method public final p(J)V
    ...
    .line 3
    iget-object v1, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
    ...
    .line 7
    :goto_0
    iget-object v3, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
    ...
    .line 11
    :cond_1
    iget-object v3, v3, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->b:Lkotlinx/coroutines/scheduling/WorkQueue;

    iget-object v5, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lkotlinx/coroutines/scheduling/GlobalQueue;

    invoke-virtual {v3, v5}, Lkotlinx/coroutines/scheduling/WorkQueue;->g(Lkotlinx/coroutines/scheduling/GlobalQueue;)V
    ...
    .line 12
    :cond_3
    iget-object p1, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->g:Lkotlinx/coroutines/scheduling/GlobalQueue;
    ...
    .line 14
    invoke-virtual {v0, v2}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->f(Z)Lkotlinx/coroutines/scheduling/Task;
    ...
    invoke-virtual {v0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->s(Lkotlinx/coroutines/scheduling/CoroutineScheduler$WorkerState;)Z
    ...
    .line 20
    :cond_6
    invoke-virtual {p0, p1}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->o(Lkotlinx/coroutines/scheduling/Task;)V
...
.method public toString()Ljava/lang/String;
    ...
    .line 3
    iget-object v9, p0, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->h:Lkotlinx/coroutines/internal/ResizableAtomicArray;
    ...
    .line 4
    :cond_0
    iget-object v10, v9, Lkotlinx/coroutines/scheduling/CoroutineScheduler$Worker;->b:Lkotlinx/coroutines/scheduling/WorkQueue;
...
.method public final u()V
    ...
    .line 2
    invoke-static {p0, v0, v1, v2, v3}, Lkotlinx/coroutines/scheduling/CoroutineScheduler;->y(Lkotlinx/coroutines/scheduling/CoroutineScheduler;JILjava/lang/Object;)Z
