...
.method public final concatLengthPrefixed(Ljava/util/List;)[B
    ...
    invoke-virtual {v0, v2}, Lokio/Buffer;->G0(I)Lokio/Buffer;

    .line 4
    invoke-virtual {v0, v1}, Lokio/Buffer;->P0(Ljava/lang/String;)Lokio/Buffer;

    goto :goto_0

    .line 5
    :cond_0
    invoke-virtual {v0}, Lokio/Buffer;->g0()[B
