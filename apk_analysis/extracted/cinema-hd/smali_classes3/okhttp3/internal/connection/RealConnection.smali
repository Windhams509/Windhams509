...
.method private final connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 11
    invoke-static {v1}, Lokio/Okio;->i(Ljava/net/Socket;)Lokio/Sink;
    ...
    invoke-static {p4, p3}, Lkotlin/jvm/internal/Intrinsics;->n(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method private final connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 25
    invoke-static {p1, v2, v6, v2}, Lkotlin/text/StringsKt;->e(Ljava/lang/String;Ljava/lang/String;ILjava/lang/Object;)Ljava/lang/String;
...
.method private final createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    invoke-static {v2, p3, v1}, Lkotlin/text/StringsKt;->n(Ljava/lang/String;Ljava/lang/String;Z)Z
    ...
    invoke-virtual {p1}, Lokio/Buffer;->h0()Z

    move-result p1

    if-eqz p1, :cond_4

    invoke-interface {v2}, Lokio/BufferedSink;->z()Lokio/Buffer;
