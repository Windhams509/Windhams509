...
.method public final frameHeader(IIII)V
    ...
    invoke-interface {p2, p3}, Lokio/BufferedSink;->i0(I)Lokio/BufferedSink;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {p1, p3}, Lokio/BufferedSink;->T([B)Lokio/BufferedSink;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    invoke-interface {v2, p2}, Lokio/BufferedSink;->G(I)Lokio/BufferedSink;
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-interface {v4, v3}, Lokio/BufferedSink;->d0(I)Lokio/BufferedSink;
    ...
    invoke-interface {v3, v2}, Lokio/BufferedSink;->G(I)Lokio/BufferedSink;
