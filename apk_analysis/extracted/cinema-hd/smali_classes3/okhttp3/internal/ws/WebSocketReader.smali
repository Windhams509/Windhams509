...
.method private final readControlFrame()V
    ...
    invoke-interface {v4, v5, v0, v1}, Lokio/BufferedSource;->B(Lokio/Buffer;J)V
    ...
    invoke-virtual {v0, v1}, Lokio/Buffer;->w(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;
    ...
    invoke-virtual {v1}, Lokio/Buffer;->n0()Lokio/ByteString;
...
.method private final readMessage()V
    ...
    invoke-interface {v2, v3, v0, v1}, Lokio/BufferedSource;->B(Lokio/Buffer;J)V
