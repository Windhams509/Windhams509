...
.method public constructor <init>(ZLokio/BufferedSink;Ljava/util/Random;ZZJ)V
    ...
    .line 9
    invoke-interface {p2}, Lokio/BufferedSink;->z()Lokio/Buffer;
...
.method private final writeControlFrame(ILokio/ByteString;)V
    ...
    invoke-virtual {v1, p1}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, v1}, Lokio/Buffer;->E0([B)Lokio/Buffer;
    ...
    invoke-virtual {p1, p2}, Lokio/Buffer;->C0(Lokio/ByteString;)Lokio/Buffer;
    ...
    invoke-virtual {p1, p2}, Lokio/Buffer;->w(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;
...
.method public final writeClose(ILokio/ByteString;)V
    ...
    .line 5
    invoke-virtual {v0, p2}, Lokio/Buffer;->C0(Lokio/ByteString;)Lokio/Buffer;

    .line 6
    :cond_2
    invoke-virtual {v0}, Lokio/Buffer;->n0()Lokio/ByteString;
...
.method public final writeMessageFrame(ILokio/ByteString;)V
    ...
    invoke-virtual {p2, p1}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, p2}, Lokio/Buffer;->M0(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, v1, v2}, Lokio/Buffer;->L0(J)Lokio/Buffer;
    ...
    invoke-virtual {p1, p2}, Lokio/Buffer;->E0([B)Lokio/Buffer;
    ...
    invoke-virtual {v0, v3}, Lokio/Buffer;->w(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;

    .line 19
    iget-object v0, p0, Lokhttp3/internal/ws/WebSocketWriter;->maskCursor:Lokio/Buffer$UnsafeCursor;

    invoke-virtual {v0, p1, p2}, Lokio/Buffer$UnsafeCursor;->f(J)I
