...
.method private final writeCanonicalized(Lokio/Buffer;Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)V
    ...
    .line 2
    :goto_2
    invoke-virtual {p1, v8}, Lokio/Buffer;->P0(Ljava/lang/String;)Lokio/Buffer;
    ...
    .line 3
    invoke-static {v12, v8, v10, v11, v4}, Lkotlin/text/StringsKt;->E(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    .line 5
    :cond_6
    invoke-virtual {p1, v7}, Lokio/Buffer;->R0(I)Lokio/Buffer;
    ...
    invoke-virtual {v6, v1, v5, v10, v3}, Lokio/Buffer;->N0(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/Buffer;
    ...
    :cond_b
    :goto_4
    invoke-virtual {v6, v7}, Lokio/Buffer;->R0(I)Lokio/Buffer;

    .line 10
    :goto_5
    invoke-virtual {v6}, Lokio/Buffer;->h0()Z
    ...
    .line 12
    invoke-virtual {p1, v9}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, v11}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, v10}, Lokio/Buffer;->G0(I)Lokio/Buffer;
...
.method private final writePercentDecoded(Lokio/Buffer;Ljava/lang/String;IIZ)V
    ...
    .line 4
    invoke-virtual {p1, p3}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    .line 7
    :cond_1
    invoke-virtual {p1, v0}, Lokio/Buffer;->R0(I)Lokio/Buffer;
...
.method public final canonicalize$okhttp(Ljava/lang/String;IILjava/lang/String;ZZZZLjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 2
    invoke-static {v5, v1, v6, v7, v8}, Lkotlin/text/StringsKt;->E(Ljava/lang/CharSequence;CZILjava/lang/Object;)Z
    ...
    .line 6
    invoke-virtual {v12, p1, p2, v3}, Lokio/Buffer;->Q0(Ljava/lang/String;II)Lokio/Buffer;
    ...
    .line 8
    invoke-virtual {v12}, Lokio/Buffer;->p0()Ljava/lang/String;
...
.method public final percentDecode$okhttp(Ljava/lang/String;IIZ)Ljava/lang/String;
    ...
    .line 3
    invoke-virtual {v0, p1, p2, v4}, Lokio/Buffer;->Q0(Ljava/lang/String;II)Lokio/Buffer;
...
.method public final toQueryNamesAndValues$okhttp(Ljava/lang/String;)Ljava/util/List;
    ...
    .line 3
    invoke-static/range {v2 .. v7}, Lkotlin/text/StringsKt;->P(Ljava/lang/CharSequence;CIZILjava/lang/Object;)I
