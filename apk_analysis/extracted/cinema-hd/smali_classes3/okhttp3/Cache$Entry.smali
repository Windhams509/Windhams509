...
.method private final readCertificateList(Lokio/BufferedSource;)Ljava/util/List;
    ...
    .line 7
    sget-object v6, Lokio/ByteString;->e:Lokio/ByteString$Companion;
    ...
    invoke-virtual {v5, v4}, Lokio/Buffer;->C0(Lokio/ByteString;)Lokio/Buffer;

    .line 8
    invoke-virtual {v5}, Lokio/Buffer;->A()Ljava/io/InputStream;
...
.method private final writeCertList(Lokio/BufferedSink;Ljava/util/List;)V
    ...
    invoke-interface {p1, v0, v1}, Lokio/BufferedSink;->Z(J)Lokio/BufferedSink;
    ...
    .line 4
    sget-object v2, Lokio/ByteString;->e:Lokio/ByteString$Companion;
    ...
    .line 5
    invoke-interface {p1, v0}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-interface {p1, v3, v4}, Lokio/BufferedSink;->Z(J)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v6}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v6

    .line 7
    invoke-interface {v6, v4}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v4, v3}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v3

    .line 9
    invoke-interface {v3, v2}, Lokio/BufferedSink;->i0(I)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v5, v6}, Lokio/BufferedSink;->Z(J)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v5}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v5

    .line 14
    invoke-interface {v5, v4}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v5, v0}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v0, v5, v6}, Lokio/BufferedSink;->Z(J)Lokio/BufferedSink;
    ...
    invoke-interface {v0, v3, v4}, Lokio/BufferedSink;->Z(J)Lokio/BufferedSink;
    ...
    .line 26
    invoke-interface {p1, v2}, Lokio/BufferedSink;->i0(I)Lokio/BufferedSink;
