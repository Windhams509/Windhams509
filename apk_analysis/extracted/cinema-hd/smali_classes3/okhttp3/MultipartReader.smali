...
.method static constructor <clinit>()V
    ...
    .line 1
    sget-object v0, Lokio/Options;->e:Lokio/Options$Companion;
...
.method public constructor <init>(Lokio/BufferedSource;Ljava/lang/String;)V
    ...
    .line 5
    invoke-virtual {p1, v0}, Lokio/Buffer;->P0(Ljava/lang/String;)Lokio/Buffer;

    move-result-object p1

    .line 6
    invoke-virtual {p1, p2}, Lokio/Buffer;->P0(Ljava/lang/String;)Lokio/Buffer;

    move-result-object p1

    .line 7
    invoke-virtual {p1}, Lokio/Buffer;->n0()Lokio/ByteString;
...
.method private final currentPartBytesRemaining(J)J
    ...
    invoke-interface {v0, v1, v2}, Lokio/BufferedSource;->Y(J)V

    .line 2
    iget-object v0, p0, Lokhttp3/MultipartReader;->source:Lokio/BufferedSource;

    invoke-interface {v0}, Lokio/BufferedSource;->z()Lokio/Buffer;
...
.method public final nextPart()Lokhttp3/MultipartReader$Part;
    ...
    invoke-interface {v0, v3, v4, v5}, Lokio/BufferedSource;->O(JLokio/ByteString;)Z
    ...
    invoke-interface {v3, v4}, Lokio/BufferedSource;->w0(Lokio/Options;)I
