...
.method private final writeOrCountBytes(Lokio/BufferedSink;Z)J
    ...
    invoke-interface {p1}, Lokio/BufferedSink;->z()Lokio/Buffer;
    ...
    .line 3
    invoke-virtual {p1, v3}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    invoke-virtual {p1, v3}, Lokio/Buffer;->P0(Ljava/lang/String;)Lokio/Buffer;
