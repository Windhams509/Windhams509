...
.method private final writeOrCountBytes(Lokio/BufferedSink;Z)J
    ...
    invoke-interface {p1, v8}, Lokio/BufferedSink;->T([B)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v11}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v11, v12}, Lokio/BufferedSink;->T([B)Lokio/BufferedSink;
    ...
    invoke-interface {v11, v9}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v9, v11}, Lokio/BufferedSink;->T([B)Lokio/BufferedSink;
    ...
    .line 15
    invoke-interface {p1, v8}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v8, v7}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v7, v8}, Lokio/BufferedSink;->T([B)Lokio/BufferedSink;
    ...
    .line 19
    invoke-interface {p1, v9}, Lokio/BufferedSink;->N(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v9

    .line 20
    invoke-interface {v9, v7, v8}, Lokio/BufferedSink;->Z(J)Lokio/BufferedSink;
    ...
    invoke-interface {v9, v10}, Lokio/BufferedSink;->T([B)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v9}, Lokio/BufferedSink;->T([B)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v1}, Lokio/BufferedSink;->T([B)Lokio/BufferedSink;
