...
.method constructor <init>(Ljava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/functions/Functions$TimestampFunction;->b:Ljava/util/concurrent/TimeUnit;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/functions/Functions$TimestampFunction;->c:Lio/reactivex/Scheduler;
...
.method public a(Ljava/lang/Object;)Lio/reactivex/schedulers/Timed;
    ...
    iget-object v1, p0, Lio/reactivex/internal/functions/Functions$TimestampFunction;->c:Lio/reactivex/Scheduler;

    iget-object v2, p0, Lio/reactivex/internal/functions/Functions$TimestampFunction;->b:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v1, v2}, Lio/reactivex/Scheduler;->b(Ljava/util/concurrent/TimeUnit;)J

    move-result-wide v1

    iget-object v3, p0, Lio/reactivex/internal/functions/Functions$TimestampFunction;->b:Ljava/util/concurrent/TimeUnit;
