...
.method public constructor <init>(Lio/reactivex/ObservableSource;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;JIZ)V
    ...
    .line 2
    iput-wide p2, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->c:J

    .line 3
    iput-wide p4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->d:J

    .line 4
    iput-object p6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->e:Ljava/util/concurrent/TimeUnit;

    .line 5
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->f:Lio/reactivex/Scheduler;

    .line 6
    iput-wide p8, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->g:J

    .line 7
    iput p10, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->h:I

    .line 8
    iput-boolean p11, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->i:Z
...
.method public subscribeActual(Lio/reactivex/Observer;)V
    ...
    .line 2
    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->c:J

    iget-wide v4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->d:J
    ...
    .line 4
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/AbstractObservableWithUpstream;->b:Lio/reactivex/ObservableSource;

    new-instance v7, Lio/reactivex/internal/operators/observable/ObservableWindowTimed$WindowExactUnboundedObserver;

    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->c:J

    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->e:Ljava/util/concurrent/TimeUnit;
    ...
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->e:Ljava/util/concurrent/TimeUnit;
