...
.method constructor <init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->b:Ljava/lang/Runnable;
    ...
    iput-object p1, p0, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 5
    iput-object p2, p0, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->e:Ljava/util/concurrent/ExecutorService;
...
.method public b()Ljava/lang/Void;
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->b:Ljava/lang/Runnable;

    invoke-interface {v1}, Ljava/lang/Runnable;->run()V

    .line 3
    iget-object v1, p0, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->e:Ljava/util/concurrent/ExecutorService;

    invoke-interface {v1, p0}, Ljava/util/concurrent/ExecutorService;->submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;

    move-result-object v1

    invoke-virtual {p0, v1}, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->d(Ljava/util/concurrent/Future;)V
    ...
    .line 6
    invoke-static {v1}, Lio/reactivex/plugins/RxJavaPlugins;->s(Ljava/lang/Throwable;)V
...
.method c(Ljava/util/concurrent/Future;)V
    ...
    .line 1
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 4
    :cond_2
    iget-object v1, p0, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public bridge synthetic call()Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lio/reactivex/internal/schedulers/InstantPeriodicTask;->b()Ljava/lang/Void;
