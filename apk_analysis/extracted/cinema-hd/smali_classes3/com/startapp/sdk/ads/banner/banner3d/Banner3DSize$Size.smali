...
# instance fields
.field private size:Lcom/startapp/r3;
...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v0, v2, v4, v1}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/r3;)V
    ...
    invoke-direct {v2, v5, v3}, Lcom/startapp/r3;-><init>(II)V

    const-string v5, "XSMALL"

    const/4 v6, 0x1

    invoke-direct {v1, v5, v6, v2}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/r3;)V
    ...
    new-instance v5, Lcom/startapp/r3;

    const/16 v7, 0x140

    invoke-direct {v5, v7, v3}, Lcom/startapp/r3;-><init>(II)V

    const-string v3, "SMALL"

    const/4 v7, 0x2

    invoke-direct {v2, v3, v7, v5}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/r3;)V
    ...
    invoke-direct {v5, v8, v9}, Lcom/startapp/r3;-><init>(II)V

    const-string v8, "MEDIUM"

    const/4 v9, 0x3

    invoke-direct {v3, v8, v9, v5}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/r3;)V
    ...
    new-instance v8, Lcom/startapp/r3;

    const/16 v10, 0x2d8

    const/16 v11, 0x5a

    invoke-direct {v8, v10, v11}, Lcom/startapp/r3;-><init>(II)V

    const-string v10, "LARGE"

    const/4 v12, 0x4

    invoke-direct {v5, v10, v12, v8}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/r3;)V
    ...
    new-instance v10, Lcom/startapp/r3;

    const/16 v13, 0x400

    invoke-direct {v10, v13, v11}, Lcom/startapp/r3;-><init>(II)V

    const-string v11, "XLARGE"

    const/4 v13, 0x5

    invoke-direct {v8, v11, v13, v10}, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;-><init>(Ljava/lang/String;ILcom/startapp/r3;)V
...
.method private constructor <init>(Ljava/lang/String;ILcom/startapp/r3;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p3, p0, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;->size:Lcom/startapp/r3;
...
# virtual methods
.method public getSize()Lcom/startapp/r3;
    .locals 1

    iget-object v0, p0, Lcom/startapp/sdk/ads/banner/banner3d/Banner3DSize$Size;->size:Lcom/startapp/r3;
