...
.field public static final enum e:Lcom/startapp/networkTest/controller/LocationController$ProviderMode;
...
.method public static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;

    const-string v3, "Network"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;->b:Lcom/startapp/networkTest/controller/LocationController$ProviderMode;

    .line 3
    new-instance v3, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;

    const-string v5, "Gps"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;->c:Lcom/startapp/networkTest/controller/LocationController$ProviderMode;

    .line 4
    new-instance v5, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;

    const-string v7, "GpsAndNetwork"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;->d:Lcom/startapp/networkTest/controller/LocationController$ProviderMode;

    .line 5
    new-instance v7, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;

    const-string v9, "RailNet"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;->e:Lcom/startapp/networkTest/controller/LocationController$ProviderMode;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/startapp/networkTest/controller/LocationController$ProviderMode;
    ...
    .line 6
    sput-object v9, Lcom/startapp/networkTest/controller/LocationController$ProviderMode;->f:[Lcom/startapp/networkTest/controller/LocationController$ProviderMode;
