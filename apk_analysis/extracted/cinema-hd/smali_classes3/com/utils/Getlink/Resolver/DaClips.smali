.class public Lcom/utils/Getlink/Resolver/DaClips;
...
.method protected n(Lcom/original/tase/model/media/MediaSource;Lio/reactivex/ObservableEmitter;)V
    ...
    const-string v1, "(?://|\\.)(daclips\\.(?:in|com))/(?:embed-)?([0-9a-zA-Z]+)"
    ...
    const-string v2, "https://daclips.in/"
    ...
    const-string v2, "404 - File Not Found"
    ...
    invoke-virtual {p0}, Lcom/utils/Getlink/Resolver/DaClips;->d()Ljava/lang/String;
