.class public Lcom/utils/Getlink/Resolver/DownAce;
...
.method protected n(Lcom/original/tase/model/media/MediaSource;Lio/reactivex/ObservableEmitter;)V
    ...
    const-string v2, "(?://|\\.)(downace\\.com)/(?:embed/)?([0-9a-zA-Z]+)"
    ...
    const-string v5, "https://downace.com/embed/"
    ...
    const-string v3, "controls\\s+preload.*?src=\"([^\"]+)"

    const/4 v4, 0x1

    const/16 v5, 0x22

    invoke-static {v1, v3, v4, v5}, Lcom/original/tase/utils/Regex;->b(Ljava/lang/String;Ljava/lang/String;II)Ljava/lang/String;

    move-result-object v1

    .line 4
    invoke-static {v1}, Lcom/utils/Getlink/Resolver/BaseResolver;->a(Ljava/lang/String;)Z
    ...
    const-string v3, "https://downace.com"
    ...
    invoke-virtual {p0}, Lcom/utils/Getlink/Resolver/DownAce;->d()Ljava/lang/String;

    move-result-object v3

    const-string v4, "HD"

    invoke-direct {v0, v3, v1, v4}, Lcom/original/tase/model/ResolveResult;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
