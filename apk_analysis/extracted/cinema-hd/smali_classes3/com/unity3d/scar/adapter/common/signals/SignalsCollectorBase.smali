...
# virtual methods
.method public a(Landroid/content/Context;[Ljava/lang/String;[Ljava/lang/String;Lcom/unity3d/scar/adapter/common/signals/ISignalCollectionListener;)V
    .locals 11
    ...
    .line 4
    invoke-virtual {v6}, Lcom/unity3d/scar/adapter/common/DispatchGroup;->a()V
    ...
    .line 5
    invoke-interface/range {v0 .. v5}, Lcom/unity3d/scar/adapter/common/signals/ISignalsCollector;->d(Landroid/content/Context;Ljava/lang/String;ZLcom/unity3d/scar/adapter/common/DispatchGroup;Lcom/unity3d/scar/adapter/common/signals/SignalsResult;)V
    ...
    invoke-virtual {v6, p1}, Lcom/unity3d/scar/adapter/common/DispatchGroup;->c(Ljava/lang/Runnable;)V

    return-void
.end method

.method public b(Landroid/content/Context;Lcom/unity3d/scar/adapter/common/signals/ISignalCollectionListener;)V
    .locals 3
    ...
    .line 3
    invoke-virtual {v0}, Lcom/unity3d/scar/adapter/common/DispatchGroup;->a()V

    const/4 v2, 0x1

    .line 4
    invoke-interface {p0, p1, v2, v0, v1}, Lcom/unity3d/scar/adapter/common/signals/ISignalsCollector;->c(Landroid/content/Context;ZLcom/unity3d/scar/adapter/common/DispatchGroup;Lcom/unity3d/scar/adapter/common/signals/SignalsResult;)V
    ...
    invoke-virtual {v0, p1}, Lcom/unity3d/scar/adapter/common/DispatchGroup;->c(Ljava/lang/Runnable;)V

    return-void
.end method

.method public e(Ljava/lang/String;Lcom/unity3d/scar/adapter/common/DispatchGroup;Lcom/unity3d/scar/adapter/common/signals/SignalsResult;)V
    .locals 2
    ...
    invoke-virtual {p3, p1}, Lcom/unity3d/scar/adapter/common/signals/SignalsResult;->d(Ljava/lang/String;)V

    .line 2
    invoke-virtual {p2}, Lcom/unity3d/scar/adapter/common/DispatchGroup;->b()V
