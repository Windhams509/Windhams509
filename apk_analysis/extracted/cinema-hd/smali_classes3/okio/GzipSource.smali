...
.method private final d()V
    ...
    invoke-virtual {v0, v1, v2}, Lokio/RealBufferedSource;->Y(J)V
    ...
    .line 6
    iget-object v1, v0, Lokio/RealBufferedSource;->c:Lokio/Buffer;
    ...
    .line 7
    invoke-direct/range {v0 .. v5}, Lokio/GzipSource;->f(Lokio/Buffer;JJ)V
    ...
    .line 9
    invoke-direct {v6, v2, v1, v0}, Lokio/GzipSource;->b(Ljava/lang/String;II)V
    ...
    invoke-virtual {v0, v11, v12}, Lokio/RealBufferedSource;->Y(J)V
    ...
    invoke-virtual {v0, v9}, Lokio/RealBufferedSource;->b(B)J
    ...
    invoke-direct {v6, v2, v0, v1}, Lokio/GzipSource;->b(Ljava/lang/String;II)V
...
.method private final e()V
    ...
    invoke-virtual {v0}, Lokio/RealBufferedSource;->f()I
    ...
    invoke-direct {p0, v1, v0, v2}, Lokio/GzipSource;->b(Ljava/lang/String;II)V
...
.method private final f(Lokio/Buffer;JJ)V
    .locals 5
...
.method public read(Lokio/Buffer;J)J
    ...
    .line 1
    :cond_1
    iget-byte v0, p0, Lokio/GzipSource;->b:B

    if-nez v0, :cond_2

    .line 2
    invoke-direct {p0}, Lokio/GzipSource;->d()V

    .line 3
    iput-byte v2, p0, Lokio/GzipSource;->b:B
    ...
    .line 7
    invoke-direct/range {v5 .. v10}, Lokio/GzipSource;->f(Lokio/Buffer;JJ)V

    return-wide p2

    .line 8
    :cond_3
    iput-byte v1, p0, Lokio/GzipSource;->b:B
    ...
    .line 10
    invoke-direct {p0}, Lokio/GzipSource;->e()V
    ...
    invoke-virtual {p1}, Lokio/RealBufferedSource;->h0()Z
