...
.method public static synthetic x(Lokio/Buffer;Lokio/Buffer$UnsafeCursor;ILjava/lang/Object;)Lokio/Buffer$UnsafeCursor;
    .locals 0
    ...
    .line 1
    invoke-static {}, Lokio/_UtilKt;->c()Lokio/Buffer$UnsafeCursor;

    move-result-object p1

    .line 2
    :cond_0
    invoke-virtual {p0, p1}, Lokio/Buffer;->w(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;
...
.method public final A0(I)Lokio/ByteString;
    .locals 8
...
.method public final B0(I)Lokio/Segment;
    .locals 3
    ...
    .line 3
    iput-object p1, p0, Lokio/Buffer;->b:Lokio/Segment;
...
.method public C0(Lokio/ByteString;)Lokio/Buffer;
    .locals 2
    ...
    .line 2
    invoke-virtual {p1, p0, v1, v0}, Lokio/ByteString;->C(Lokio/Buffer;II)V
...
.method public D0(Lokio/Source;J)Lokio/Buffer;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public bridge synthetic E()Lokio/BufferedSink;
    .locals 1
...
.method public E0([B)Lokio/Buffer;
    .locals 2
    ...
    invoke-virtual {p0, p1, v1, v0}, Lokio/Buffer;->F0([BII)Lokio/Buffer;
...
.method public F0([BII)Lokio/Buffer;
    .locals 9
    ...
    .line 2
    invoke-virtual {p0, v0}, Lokio/Buffer;->B0(I)Lokio/Segment;
...
.method public bridge synthetic G(I)Lokio/BufferedSink;
    .locals 0
...
.method public G0(I)Lokio/Buffer;
    ...
    invoke-virtual {p0, v0, v1}, Lokio/Buffer;->y0(J)V

    return-object p0
.end method

.method public H0(J)Lokio/Buffer;
    .locals 12
    ...
    .line 2
    invoke-virtual {p0, p1}, Lokio/Buffer;->P0(Ljava/lang/String;)Lokio/Buffer;
    ...
    .line 3
    :cond_15
    invoke-virtual {p0, v4}, Lokio/Buffer;->B0(I)Lokio/Segment;
    ...
    .line 7
    invoke-static {}, Lokio/internal/_BufferKt;->b()[B
...
.method public I()S
    ...
    invoke-static {v0}, Lokio/_UtilKt;->g(S)S
...
.method public I0(J)Lokio/Buffer;
    ...
    .line 3
    invoke-virtual {p0, v1}, Lokio/Buffer;->B0(I)Lokio/Segment;
...
.method public bridge synthetic K()Lokio/BufferedSink;
    .locals 1
...
.method public K0(I)Lokio/Buffer;
    ...
    invoke-static {p1}, Lokio/_UtilKt;->f(I)I
...
.method public L(J)Ljava/lang/String;
    ...
    .line 1
    invoke-virtual/range {v4 .. v9}, Lokio/Buffer;->m(BJJ)J
    ...
    .line 2
    invoke-static {p0, v4, v5}, Lokio/internal/_BufferKt;->d(Lokio/Buffer;J)Ljava/lang/String;
    ...
    .line 6
    invoke-static {p0, v2, v3}, Lokio/internal/_BufferKt;->d(Lokio/Buffer;J)Ljava/lang/String;
    ...
    .line 10
    invoke-virtual/range {v0 .. v5}, Lokio/Buffer;->i(Lokio/Buffer;JJ)Lokio/Buffer;
    ...
    .line 15
    invoke-virtual {v6}, Lokio/Buffer;->n0()Lokio/ByteString;
...
.method public L0(J)Lokio/Buffer;
    .locals 9
...
.method public bridge synthetic N(Ljava/lang/String;)Lokio/BufferedSink;
    .locals 0
...
.method public N0(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/Buffer;
    .locals 3
    ...
    invoke-virtual {p0, p1, p2, p3}, Lokio/Buffer;->Q0(Ljava/lang/String;II)Lokio/Buffer;
    ...
    invoke-virtual {p0, p1, v1, p2}, Lokio/Buffer;->F0([BII)Lokio/Buffer;
...
.method public O(JLokio/ByteString;)Z
    ...
    invoke-virtual/range {v1 .. v6}, Lokio/Buffer;->u(JLokio/ByteString;II)Z
...
.method public O0(Ljava/lang/String;Ljava/nio/charset/Charset;)Lokio/Buffer;
    .locals 2
    ...
    .line 2
    invoke-virtual {p0, p1, v1, v0, p2}, Lokio/Buffer;->N0(Ljava/lang/String;IILjava/nio/charset/Charset;)Lokio/Buffer;
...
.method public P(Lokio/Source;)J
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public P0(Ljava/lang/String;)Lokio/Buffer;
    .locals 2
    ...
    invoke-virtual {p0, p1, v1, v0}, Lokio/Buffer;->Q0(Ljava/lang/String;II)Lokio/Buffer;
...
.method public Q0(Ljava/lang/String;II)Lokio/Buffer;
    .locals 11
    ...
    invoke-virtual {p0, v2, v3}, Lokio/Buffer;->y0(J)V
    ...
    :cond_b
    :goto_9
    invoke-virtual {p0, v5}, Lokio/Buffer;->G0(I)Lokio/Buffer;
...
.method public R()Ljava/lang/String;
    ...
    invoke-virtual {p0, v0, v1}, Lokio/Buffer;->L(J)Ljava/lang/String;
...
.method public R0(I)Lokio/Buffer;
    ...
    .line 7
    invoke-virtual {p0, v2}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    invoke-static {p1}, Lokio/_UtilKt;->i(I)Ljava/lang/String;

    move-result-object p1

    const-string v1, "Unexpected code point: 0x"

    invoke-static {v1, p1}, Lkotlin/jvm/internal/Intrinsics;->n(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
...
.method public bridge synthetic T([B)Lokio/BufferedSink;
    .locals 0

    invoke-virtual {p0, p1}, Lokio/Buffer;->E0([B)Lokio/Buffer;
...
.method public bridge synthetic Z(J)Lokio/BufferedSink;
    .locals 0

    invoke-virtual {p0, p1, p2}, Lokio/Buffer;->H0(J)Lokio/Buffer;
...
.method public bridge synthetic a([BII)Lokio/BufferedSink;
    .locals 0

    invoke-virtual {p0, p1, p2, p3}, Lokio/Buffer;->F0([BII)Lokio/Buffer;
...
.method public b0(JLjava/nio/charset/Charset;)Ljava/lang/String;
    ...
    .line 4
    invoke-virtual {p0, p1, p2}, Lokio/Buffer;->S(J)[B
...
.method public c0(J)Lokio/ByteString;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/EOFException;
    ...
    .line 2
    invoke-virtual {p0, v0}, Lokio/Buffer;->A0(I)Lokio/ByteString;
...
.method public bridge synthetic d0(I)Lokio/BufferedSink;
    .locals 0
...
.method public final f()Lokio/Buffer;
    ...
    .line 5
    iput-object v2, v0, Lokio/Buffer;->b:Lokio/Segment;
    ...
    invoke-virtual {v0, v1, v2}, Lokio/Buffer;->y0(J)V
...
.method public g0()[B
    ...
    invoke-virtual {p0, v0, v1}, Lokio/Buffer;->S(J)[B
...
.method public final i(Lokio/Buffer;JJ)Lokio/Buffer;
    .locals 8
    ...
    invoke-virtual {p1, v2, v3}, Lokio/Buffer;->y0(J)V
    ...
    .line 9
    iget-object p2, p1, Lokio/Buffer;->b:Lokio/Segment;
    ...
    .line 12
    iput-object v3, p1, Lokio/Buffer;->b:Lokio/Segment;
...
.method public bridge synthetic i0(I)Lokio/BufferedSink;
    .locals 0
...
.method public j0()J
    ...
    invoke-virtual {v1, v8, v9}, Lokio/Buffer;->H0(J)Lokio/Buffer;

    move-result-object v1

    invoke-virtual {v1, v15}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    invoke-virtual {v1}, Lokio/Buffer;->p0()Ljava/lang/String;

    move-result-object v1

    const-string v3, "Number too large: "

    invoke-static {v3, v1}, Lkotlin/jvm/internal/Intrinsics;->n(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    iput-object v3, v0, Lokio/Buffer;->b:Lokio/Segment;
    ...
    .line 13
    iget-object v3, v0, Lokio/Buffer;->b:Lokio/Segment;
    ...
    invoke-static {v1}, Lokio/_UtilKt;->h(B)Ljava/lang/String;
...
.method public m(BJJ)J
    ...
    .line 2
    iget-object v3, v5, Lokio/Buffer;->b:Lokio/Segment;
    ...
    .line 8
    iget v12, v3, Lokio/Segment;->c:I

    int-to-long v12, v12

    iget v14, v3, Lokio/Segment;->b:I
...
.method public bridge synthetic m0(J)Lokio/BufferedSink;
    .locals 0

    invoke-virtual {p0, p1, p2}, Lokio/Buffer;->I0(J)Lokio/Buffer;
...
.method public n0()Lokio/ByteString;
    .locals 2
    ...
    invoke-virtual {p0, v0, v1}, Lokio/Buffer;->c0(J)Lokio/ByteString;
...
.method public o(Lokio/ByteString;J)J
    ...
    .line 7
    :cond_4
    invoke-virtual/range {p1 .. p1}, Lokio/ByteString;->o()[B
    ...
    .line 11
    iget-object v10, v8, Lokio/Segment;->a:[B
    ...
    invoke-static {v8, v5, v9, v11, v1}, Lokio/internal/_BufferKt;->c(Lokio/Segment;I[BII)Z
    ...
    .line 24
    iget-object v11, v6, Lokio/Segment;->a:[B

    .line 25
    iget v12, v6, Lokio/Segment;->c:I

    iget v13, v6, Lokio/Segment;->b:I
    ...
    invoke-static {v6, v5, v3, v13, v1}, Lokio/internal/_BufferKt;->c(Lokio/Segment;I[BII)Z
    ...
    .line 30
    :goto_9
    iget v4, v6, Lokio/Segment;->c:I

    iget v5, v6, Lokio/Segment;->b:I
...
.method public q(Lokio/ByteString;J)J
    ...
    .line 17
    :cond_6
    invoke-virtual {p1}, Lokio/ByteString;->o()[B
...
.method public bridge synthetic r0(Lokio/ByteString;)Lokio/BufferedSink;
    ...
    invoke-virtual {p0, p1}, Lokio/Buffer;->C0(Lokio/ByteString;)Lokio/Buffer;
...
.method public readByte()B
    ...
    invoke-virtual {p0, v5, v6}, Lokio/Buffer;->y0(J)V
...
.method public readLong()J
    ...
    invoke-virtual {p0, v7, v8}, Lokio/Buffer;->y0(J)V
...
.method public skip(J)V
    ...
    invoke-virtual {p0, v3, v4}, Lokio/Buffer;->y0(J)V
...
.method public toString()Ljava/lang/String;
    ...
    invoke-virtual {p0}, Lokio/Buffer;->z0()Lokio/ByteString;
...
.method public u(JLokio/ByteString;II)Z
    .locals 6
    ...
    invoke-virtual {p3, v1}, Lokio/ByteString;->i(I)B
...
.method public v0()J
    ...
    invoke-virtual {v0, v4, v5}, Lokio/Buffer;->I0(J)Lokio/Buffer;

    move-result-object v0

    invoke-virtual {v0, v10}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    invoke-virtual {v0}, Lokio/Buffer;->p0()Ljava/lang/String;

    move-result-object v0

    const-string v2, "Number too large: "

    invoke-static {v2, v0}, Lkotlin/jvm/internal/Intrinsics;->n(Ljava/lang/String;Ljava/lang/Object;)Ljava/lang/String;
    ...
    .line 10
    invoke-static {v10}, Lokio/_UtilKt;->h(B)Ljava/lang/String;
    ...
    iput-object v7, p0, Lokio/Buffer;->b:Lokio/Segment;
    ...
    invoke-virtual {p0, v1, v2}, Lokio/Buffer;->y0(J)V
...
.method public final w(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;
    ...
    invoke-static {p0, p1}, Lokio/internal/_BufferKt;->a(Lokio/Buffer;Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;
...
.method public w0(Lokio/Options;)I
    .locals 3
    ...
    .line 1
    invoke-static {p0, p1, v0, v1, v2}, Lokio/internal/_BufferKt;->f(Lokio/Buffer;Lokio/Options;ZILjava/lang/Object;)I
    ...
    .line 2
    :cond_0
    invoke-virtual {p1}, Lokio/Options;->i()[Lokio/ByteString;
...
.method public write(Ljava/nio/ByteBuffer;)I
    ...
    .line 2
    invoke-virtual {p0, v2}, Lokio/Buffer;->B0(I)Lokio/Segment;
...
.method public write(Lokio/Buffer;J)V
    ...
    invoke-static/range {v2 .. v7}, Lokio/_UtilKt;->b(JJJ)V
    ...
    invoke-virtual {p1, v4, v5}, Lokio/Buffer;->y0(J)V
    ...
    invoke-virtual {p0, v4, v5}, Lokio/Buffer;->y0(J)V
...
.method public x0()I
    ...
    .line 4
    invoke-virtual {p0, v12, v13}, Lokio/Buffer;->l(J)B
    ...
    invoke-static {v0}, Lokio/_UtilKt;->h(B)Ljava/lang/String;
...
.method public y()I
    ...
    invoke-static {v0}, Lokio/_UtilKt;->f(I)I
...
.method public z()Lokio/Buffer;
    .locals 0

    return-object p0
.end method

.method public final z0()Lokio/ByteString;
    .locals 5
    ...
    invoke-virtual {p0, v1}, Lokio/Buffer;->A0(I)Lokio/ByteString;
