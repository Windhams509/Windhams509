...
.method protected constructor <init>(Lcom/google/android/exoplayer2/source/TrackGroup;[IILcom/google/android/exoplayer2/upstream/BandwidthMeter;JJJFFLjava/util/List;Lcom/google/android/exoplayer2/util/Clock;)V
    ...
    .line 9
    invoke-static {p13}, Lcom/google/common/collect/ImmutableList;->q(Ljava/util/Collection;)Lcom/google/common/collect/ImmutableList;
...
.method private A(J)J
    ...
    .line 1
    invoke-direct {p0, p1, p2}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->G(J)J
...
.method private D([Lcom/google/android/exoplayer2/source/chunk/MediaChunkIterator;Ljava/util/List;)J
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 7
    :cond_2
    invoke-direct {p0, p2}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->B(Ljava/util/List;)J
...
.method private static E([Lcom/google/android/exoplayer2/trackselection/ExoTrackSelection$Definition;)[[J
    .locals 9
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method private static F([[J)Lcom/google/common/collect/ImmutableList;
    .locals 17
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method static synthetic v([Lcom/google/android/exoplayer2/trackselection/ExoTrackSelection$Definition;)Lcom/google/common/collect/ImmutableList;
    .locals 0

    invoke-static {p0}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->z([Lcom/google/android/exoplayer2/trackselection/ExoTrackSelection$Definition;)Lcom/google/common/collect/ImmutableList;
...
.method private static w(Ljava/util/List;[J)V
    ...
    invoke-virtual {v3, v4}, Lcom/google/common/collect/ImmutableList$Builder;->d(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$Builder;
...
.method private y(JJ)I
    ...
    .line 1
    invoke-direct {p0, p3, p4}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->A(J)J
    ...
    .line 3
    invoke-virtual {p0, v0, p1, p2}, Lcom/google/android/exoplayer2/trackselection/BaseTrackSelection;->c(IJ)Z
    ...
    .line 4
    :cond_0
    invoke-virtual {p0, v0}, Lcom/google/android/exoplayer2/trackselection/BaseTrackSelection;->e(I)Lcom/google/android/exoplayer2/Format;
    ...
    invoke-virtual {p0, v1, v2, p3, p4}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->x(Lcom/google/android/exoplayer2/Format;IJ)Z
...
.method private static z([Lcom/google/android/exoplayer2/trackselection/ExoTrackSelection$Definition;)Lcom/google/common/collect/ImmutableList;
    .locals 12
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
    ...
    invoke-virtual {v3, v6}, Lcom/google/common/collect/ImmutableList$Builder;->d(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$Builder;
    ...
    .line 8
    :cond_1
    invoke-static {p0}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->E([Lcom/google/android/exoplayer2/trackselection/ExoTrackSelection$Definition;)[[J
    ...
    .line 13
    :cond_3
    invoke-static {v0, v7}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->w(Ljava/util/List;[J)V

    .line 14
    invoke-static {v2}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->F([[J)Lcom/google/common/collect/ImmutableList;
    ...
    :cond_7
    invoke-virtual {v2}, Lcom/google/common/collect/ImmutableList$Builder;->e()Lcom/google/common/collect/ImmutableList;

    move-result-object v2

    :goto_7
    invoke-virtual {p0, v2}, Lcom/google/common/collect/ImmutableList$Builder;->d(Ljava/lang/Object;)Lcom/google/common/collect/ImmutableList$Builder;
    ...
    .line 28
    :cond_8
    invoke-virtual {p0}, Lcom/google/common/collect/ImmutableList$Builder;->e()Lcom/google/common/collect/ImmutableList;
...
.method protected I(JLjava/util/List;)Z
    ...
    invoke-static {p3}, Lcom/google/common/collect/Iterables;->c(Ljava/lang/Iterable;)Ljava/lang/Object;
...
.method public m(JLjava/util/List;)I
    ...
    .line 2
    invoke-virtual {p0, v0, v1, p3}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->I(JLjava/util/List;)Z
    ...
    .line 10
    invoke-static {v4, v5, v6}, Lcom/google/android/exoplayer2/util/Util;->d0(JF)J

    move-result-wide v4

    .line 11
    invoke-virtual {p0}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->C()J
    ...
    .line 12
    :cond_3
    invoke-direct {p0, p3}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->B(Ljava/util/List;)J

    move-result-wide v4

    invoke-direct {p0, v0, v1, v4, v5}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->y(JJ)I
    ...
    .line 18
    invoke-static {v8, v9, v1}, Lcom/google/android/exoplayer2/util/Util;->d0(JF)J
...
.method public o(JJJLjava/util/List;[Lcom/google/android/exoplayer2/source/chunk/MediaChunkIterator;)V
    .locals 5
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 2
    invoke-direct {p0, p8, p7}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->D([Lcom/google/android/exoplayer2/source/chunk/MediaChunkIterator;Ljava/util/List;)J
    ...
    .line 5
    invoke-direct {p0, p1, p2, v0, v1}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->y(JJ)I
    ...
    :cond_1
    invoke-static {p7}, Lcom/google/common/collect/Iterables;->c(Ljava/lang/Iterable;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, v3}, Lcom/google/android/exoplayer2/trackselection/BaseTrackSelection;->n(Lcom/google/android/exoplayer2/Format;)I
    ...
    .line 10
    invoke-virtual {p0, v2, p1, p2}, Lcom/google/android/exoplayer2/trackselection/BaseTrackSelection;->c(IJ)Z
    ...
    .line 11
    invoke-virtual {p0, v2}, Lcom/google/android/exoplayer2/trackselection/BaseTrackSelection;->e(I)Lcom/google/android/exoplayer2/Format;

    move-result-object p1

    .line 12
    invoke-virtual {p0, p7}, Lcom/google/android/exoplayer2/trackselection/BaseTrackSelection;->e(I)Lcom/google/android/exoplayer2/Format;
    ...
    .line 14
    invoke-direct {p0, p5, p6}, Lcom/google/android/exoplayer2/trackselection/AdaptiveTrackSelection;->H(J)J
