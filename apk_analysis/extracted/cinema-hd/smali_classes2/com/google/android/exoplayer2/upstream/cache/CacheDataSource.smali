...
.method private E(Lcom/google/android/exoplayer2/upstream/DataSpec;Z)V
    .locals 17
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    invoke-interface/range {v3 .. v8}, Lcom/google/android/exoplayer2/upstream/cache/Cache;->i(Ljava/lang/String;JJ)Lcom/google/android/exoplayer2/upstream/cache/CacheSpan;
    ...
    .line 10
    :cond_2
    iget-boolean v6, v3, Lcom/google/android/exoplayer2/upstream/cache/CacheSpan;->e:Z

    if-eqz v6, :cond_4

    .line 11
    iget-object v6, v3, Lcom/google/android/exoplayer2/upstream/cache/CacheSpan;->f:Ljava/io/File;
    ...
    .line 12
    iget-wide v7, v3, Lcom/google/android/exoplayer2/upstream/cache/CacheSpan;->c:J
    ...
    .line 14
    iget-wide v12, v3, Lcom/google/android/exoplayer2/upstream/cache/CacheSpan;->d:J
    ...
    :cond_9
    :try_start_1
    invoke-direct/range {p0 .. p0}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->l()V
    :try_end_1
    ...
    .line 52
    :cond_d
    invoke-direct/range {p0 .. p0}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->A()Z
    ...
    .line 53
    invoke-interface {v6}, Lcom/google/android/exoplayer2/upstream/DataSource;->d()Landroid/net/Uri;
...
.method private G(Lcom/google/android/exoplayer2/upstream/DataSpec;)I
    .locals 4
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0
...
.method private static w(Lcom/google/android/exoplayer2/upstream/cache/Cache;Ljava/lang/String;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    invoke-static {p0}, Lv/c;->b(Lcom/google/android/exoplayer2/upstream/cache/ContentMetadata;)Landroid/net/Uri;
...
.method public b(Lcom/google/android/exoplayer2/upstream/DataSpec;)J
    ...
    invoke-static {v2, v0, v3}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->w(Lcom/google/android/exoplayer2/upstream/cache/Cache;Ljava/lang/String;Landroid/net/Uri;)Landroid/net/Uri;
    ...
    .line 6
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->G(Lcom/google/android/exoplayer2/upstream/DataSpec;)I
    ...
    .line 8
    invoke-direct {p0, v2}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->D(I)V
    ...
    invoke-static {v0}, Lv/c;->a(Lcom/google/android/exoplayer2/upstream/cache/ContentMetadata;)J
    ...
    .line 18
    :cond_7
    invoke-direct {p0, v1, v4}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->E(Lcom/google/android/exoplayer2/upstream/DataSpec;Z)V
    ...
    .line 20
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->x(Ljava/lang/Throwable;)V
...
.method public close()V
    ...
    .line 4
    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->C()V

    .line 5
    :try_start_0
    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->l()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 6
    invoke-direct {p0, v0}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->x(Ljava/lang/Throwable;)V
...
.method public i()Ljava/util/Map;
    ...
    .line 1
    invoke-direct {p0}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->A()Z
...
.method public read([BII)I
    ...
    .line 1
    :cond_0
    iget-wide v1, p0, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->p:J
    ...
    .line 2
    :cond_1
    iget-object v1, p0, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->k:Lcom/google/android/exoplayer2/upstream/DataSpec;
    ...
    .line 3
    iget-object v2, p0, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->l:Lcom/google/android/exoplayer2/upstream/DataSpec;
    ...
    .line 5
    invoke-direct {p0, v1, v6}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->E(Lcom/google/android/exoplayer2/upstream/DataSpec;Z)V

    .line 6
    :cond_2
    iget-object v6, p0, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->m:Lcom/google/android/exoplayer2/upstream/DataSource;
    ...
    iget-wide v2, v2, Lcom/google/android/exoplayer2/upstream/DataSpec;->h:J

    cmp-long v9, v2, v7

    if-eqz v9, :cond_5

    iget-wide v9, p0, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->n:J
    ...
    .line 14
    :cond_5
    iget-object p1, v1, Lcom/google/android/exoplayer2/upstream/DataSpec;->i:Ljava/lang/String;
    ...
    invoke-direct {p0, p1}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->F(Ljava/lang/String;)V
    ...
    .line 17
    invoke-direct {p0, v1, v0}, Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource;->E(Lcom/google/android/exoplayer2/upstream/DataSpec;Z)V
...
.method public v()Lcom/google/android/exoplayer2/upstream/cache/CacheKeyFactory;
    .locals 1
