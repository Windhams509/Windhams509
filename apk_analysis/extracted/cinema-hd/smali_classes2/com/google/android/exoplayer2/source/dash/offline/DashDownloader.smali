...
# instance fields
.field private final k:Lcom/google/android/exoplayer2/source/dash/BaseUrlExclusionList;
...
.method public constructor <init>(Lcom/google/android/exoplayer2/MediaItem;Lcom/google/android/exoplayer2/upstream/ParsingLoadable$Parser;Lcom/google/android/exoplayer2/upstream/cache/CacheDataSource$Factory;Ljava/util/concurrent/Executor;)V
    ...
    iput-object p1, p0, Lcom/google/android/exoplayer2/source/dash/offline/DashDownloader;->k:Lcom/google/android/exoplayer2/source/dash/BaseUrlExclusionList;
...
.method private l(Lcom/google/android/exoplayer2/upstream/DataSource;Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;JJZLjava/util/ArrayList;)V
    .locals 26
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 1
    :goto_0
    iget-object v0, v8, Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;->c:Ljava/util/List;
    ...
    .line 3
    :try_start_0
    iget v1, v8, Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;->b:I
    :try_end_0
    ...
    :try_start_1
    invoke-direct {v7, v12, v1, v0, v9}, Lcom/google/android/exoplayer2/source/dash/offline/DashDownloader;->n(Lcom/google/android/exoplayer2/upstream/DataSource;ILcom/google/android/exoplayer2/source/dash/manifest/Representation;Z)Lcom/google/android/exoplayer2/source/dash/DashSegmentIndex;
    ...
    .line 4
    invoke-interface {v13, v14, v15}, Lcom/google/android/exoplayer2/source/dash/DashSegmentIndex;->g(J)J
    ...
    .line 5
    iget-object v1, v7, Lcom/google/android/exoplayer2/source/dash/offline/DashDownloader;->k:Lcom/google/android/exoplayer2/source/dash/BaseUrlExclusionList;

    iget-object v2, v0, Lcom/google/android/exoplayer2/source/dash/manifest/Representation;->c:Lcom/google/common/collect/ImmutableList;
    ...
    iget-object v6, v1, Lcom/google/android/exoplayer2/source/dash/manifest/BaseUrl;->a:Ljava/lang/String;

    .line 6
    invoke-virtual {v0}, Lcom/google/android/exoplayer2/source/dash/manifest/Representation;->n()Lcom/google/android/exoplayer2/source/dash/manifest/RangedUri;
    ...
    .line 10
    :cond_1
    invoke-interface {v13}, Lcom/google/android/exoplayer2/source/dash/DashSegmentIndex;->i()J
    ...
    .line 11
    invoke-interface {v13, v4, v5}, Lcom/google/android/exoplayer2/source/dash/DashSegmentIndex;->c(J)J
    ...
    .line 12
    invoke-interface {v13, v4, v5}, Lcom/google/android/exoplayer2/source/dash/DashSegmentIndex;->e(J)Lcom/google/android/exoplayer2/source/dash/manifest/RangedUri;
...
.method private m(Lcom/google/android/exoplayer2/source/dash/manifest/Representation;Ljava/lang/String;JLcom/google/android/exoplayer2/source/dash/manifest/RangedUri;)Lcom/google/android/exoplayer2/offline/SegmentDownloader$Segment;
    .locals 1
    .annotation system Ldalvik/annotation/MethodParameters;
        accessFlags = {
            0x0,
    ...
    .line 1
    invoke-static {p1, p2, p5, v0}, Lcom/google/android/exoplayer2/source/dash/DashUtil;->a(Lcom/google/android/exoplayer2/source/dash/manifest/Representation;Ljava/lang/String;Lcom/google/android/exoplayer2/source/dash/manifest/RangedUri;I)Lcom/google/android/exoplayer2/upstream/DataSpec;
...
.method private n(Lcom/google/android/exoplayer2/upstream/DataSource;ILcom/google/android/exoplayer2/source/dash/manifest/Representation;Z)Lcom/google/android/exoplayer2/source/dash/DashSegmentIndex;
    ...
    .line 1
    invoke-virtual {p3}, Lcom/google/android/exoplayer2/source/dash/manifest/Representation;->l()Lcom/google/android/exoplayer2/source/dash/DashSegmentIndex;
...
.method protected o(Lcom/google/android/exoplayer2/upstream/DataSource;Lcom/google/android/exoplayer2/source/dash/manifest/DashManifest;Z)Ljava/util/List;
    ...
    .line 9
    invoke-direct/range {v1 .. v9}, Lcom/google/android/exoplayer2/source/dash/offline/DashDownloader;->l(Lcom/google/android/exoplayer2/upstream/DataSource;Lcom/google/android/exoplayer2/source/dash/manifest/AdaptationSet;JJZLjava/util/ArrayList;)V
