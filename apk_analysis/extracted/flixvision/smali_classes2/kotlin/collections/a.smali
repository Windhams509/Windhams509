...
.method public static final getValue(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 5
    .line 6
    invoke-static {p0, p1}, Lmf/w;->getOrImplicitDefaultNullable(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final varargs mapOf([Lkotlin/Pair;)Ljava/util/Map;
    ...
    .line 18
    .line 19
    invoke-static {p0, v0}, Lkotlin/collections/a;->toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 16
    :cond_0
    invoke-static {p0}, Lmf/x;->toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final plus(Ljava/util/Map;Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lmf/x;->mapOf(Lkotlin/Pair;)Ljava/util/Map;
...
.method public static final toMap(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lkotlin/collections/a;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lmf/x;->mapOf(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lkotlin/collections/a;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;

    move-result-object p0

    invoke-static {p0}, Lkotlin/collections/a;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 7
    invoke-static {p1, p0}, Lkotlin/collections/a;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final toMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 10
    invoke-static {p0}, Lkotlin/collections/a;->toMutableMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 8
    invoke-static {p1, p0}, Lkotlin/collections/a;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
