...
# direct methods
.method public constructor <init>(Lne/o;Lse/n;Ljava/util/concurrent/Callable;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    .line 4
    iput-object p2, p0, Lye/w;->m:Lse/n;

    .line 5
    .line 6
    iput-object p3, p0, Lye/w;->n:Ljava/util/concurrent/Callable;
...
.method public subscribeActual(Lne/q;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lye/w;->n:Ljava/util/concurrent/Callable;
    ...
    .line 16
    .line 17
    iget-object v2, p0, Lye/w;->m:Lse/n;

    .line 18
    .line 19
    invoke-direct {v1, p1, v2, v0}, Lye/w$a;-><init>(Lne/q;Lse/n;Ljava/util/Collection;)V
