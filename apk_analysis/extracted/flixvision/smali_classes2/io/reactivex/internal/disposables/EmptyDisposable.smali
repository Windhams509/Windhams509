...
.field public static final enum m:Lio/reactivex/internal/disposables/EmptyDisposable;

.field public static final synthetic n:[Lio/reactivex/internal/disposables/EmptyDisposable;
...
.method public static constructor <clinit>()V
    ...
    .line 18
    .line 19
    sput-object v1, Lio/reactivex/internal/disposables/EmptyDisposable;->m:Lio/reactivex/internal/disposables/EmptyDisposable;
    ...
    .line 27
    .line 28
    sput-object v3, Lio/reactivex/internal/disposables/EmptyDisposable;->n:[Lio/reactivex/internal/disposables/EmptyDisposable;
...
.method public static complete(Lne/b;)V
    .locals 1

    .line 3
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->b:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p0, v0}, Lne/b;->onSubscribe(Lqe/b;)V

    .line 4
    invoke-interface {p0}, Lne/b;->onComplete()V

    return-void
.end method

.method public static complete(Lne/q;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p0, v0}, Lne/q;->onSubscribe(Lqe/b;)V

    .line 2
    invoke-interface {p0}, Lne/q;->onComplete()V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lne/b;)V
    .locals 1

    .line 3
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->b:Lio/reactivex/internal/disposables/EmptyDisposable;

    invoke-interface {p1, v0}, Lne/b;->onSubscribe(Lqe/b;)V

    .line 4
    invoke-interface {p1, p0}, Lne/b;->onError(Ljava/lang/Throwable;)V

    return-void
.end method

.method public static error(Ljava/lang/Throwable;Lne/q;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static error(Ljava/lang/Throwable;Lne/t;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p1, v0}, Lne/t;->onSubscribe(Lqe/b;)V

    .line 6
    invoke-interface {p1, p0}, Lne/t;->onError(Ljava/lang/Throwable;)V
...
.method public static values()[Lio/reactivex/internal/disposables/EmptyDisposable;
    ...
    .line 1
    sget-object v0, Lio/reactivex/internal/disposables/EmptyDisposable;->n:[Lio/reactivex/internal/disposables/EmptyDisposable;
